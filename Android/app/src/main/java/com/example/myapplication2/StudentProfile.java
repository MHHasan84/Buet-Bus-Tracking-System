...
public class StudentProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView buyMoreImg=view.findViewById(R.id.buy_more_img);

        buyMoreImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getFragmentManager().beginTransaction().replace(R.id.rel1, new StudentTicket()).commit();
            }
        });
